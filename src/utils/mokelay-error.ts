...
export const mokelayErrorCodes = [
  ...
  'BLOCK_INVALID_CASCADE',
  'BLOCK_CASCADE_UNSCOPED',
  'BLOCK_CASCADE_LIMIT_EXCEEDED',
  'BLOCK_INVALID_TABLE',
  ...
  'BLOCK_RENDER_INPUT_INVALID',
  'BLOCK_RENDER_FAILED',
  'BLOCK_EMAIL_INPUT_INVALID',
  'BLOCK_EMAIL_CONFIG_MISSING',
